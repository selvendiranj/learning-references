...
* [ASP.NET Identity (Accounts Management)](http://bitoftech.net/2015/01/21/asp-net-identity-2-with-asp-net-web-api-2-accounts-management)
* [ECMAScript 6 Features](https://github.com/lukehoban/es6features#readme)
* [Exception Handling](http://tutorials.jenkov.com/exception-handling-strategies/index.html)
